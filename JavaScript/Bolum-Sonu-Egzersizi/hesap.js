let bilgi = prompt("Not Giriniz 0-100")
let s;
...
if(bilgi>=0 && bilgi<=100){
    ...
    document.getElementById("info").innerHTML=sad+" "+s+" --> "+ bilgi
    }
    else{        
    document.getElementById("info").classList.add('text-primary');
    document.getElementById("info").innerHTML=smile+" "+s+" --> "+ bilgi
    }
}


else{
    document.body.innerHTML="AQ 100 den büyük yada küçük not mu geri zekalı";
}